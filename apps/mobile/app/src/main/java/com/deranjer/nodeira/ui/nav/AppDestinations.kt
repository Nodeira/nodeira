...
/**
 * Top-level destinations shown in the navigation drawer. Canvases have no destination of
 * their own — like notes, they live in the Home folder tree (see `HomeScreen`).
 */
